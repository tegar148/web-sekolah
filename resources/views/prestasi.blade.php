    ...
    <section class="py-16 md:py-24 max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-6">
            ...
            <div class="flex flex-wrap items-center bg-white p-1.5 rounded-full shadow-sm border border-gray-100 gap-1">
                <button class="px-6 py-2 bg-[#026773] text-white text-sm font-semibold rounded-full shadow-sm transition">Semua</button>
                <button class="px-6 py-2 text-gray-500 hover:bg-gray-50 hover:text-gray-900 text-sm font-medium rounded-full transition">Vokasi</button>
                <button class="px-6 py-2 text-gray-500 hover:bg-gray-50 hover:text-gray-900 text-sm font-medium rounded-full transition">Akademik</button>
                <button class="px-6 py-2 text-gray-500 hover:bg-gray-50 hover:text-gray-900 text-sm font-medium rounded-full transition">Non-Akademik</button>
            </div>
        </div>
